...
# CLI
import sys  # 1
from initial_task_package.arguments import parse_arguments
from initial_task_package.arguments import adjust_from_to_currency  # 2
from initial_task_package.conversion import convert  # 3
